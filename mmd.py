...
# Jiaxuan You et al. “Graphrnn: Generating realistic graphs with deep auto-regressive models”.
...
def rbf_kernel(x, y, sigma=1.0):
    ...
    Args:
        x, y: 1D arrays representing two distributions or points to compare.
        sigma: The bandwidth parameter that controls the width of the Gaussian kernel.
    Returns:
        The RBF kernel value between x and y.
    """
    dist = np.linalg.norm(x - y)  # Compute the Euclidean distance
    return np.exp(-dist**2 / (2 * sigma**2))  # Apply the RBF kernel formula
